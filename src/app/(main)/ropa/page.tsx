...
const productos: Producto[] = [
  { id: 1, nombre: "Polo Casual Hombre", precio: 89.90, precioOriginal: 109.90, descuento: 18, imagen: "/img/ropa-1.jpg", marca: "Nike" },
  { id: 2, nombre: "Polo Mujer Essential", precio: 79.90, precioOriginal: 99.90, descuento: 20, imagen: "/img/ropa-2.jpg", marca: "Adidas" },
  { id: 3, nombre: "Pantalon Deportivo", precio: 129.90, precioOriginal: 149.90, descuento: 13, imagen: "/img/ropa-3.jpg", marca: "Puma" },
  { id: 4, nombre: "Camiseta Básica", precio: 59.90, precioOriginal: 79.90, descuento: 25, imagen: "/img/ropa-4.jpg", marca: "Clarks" },
  { id: 5, nombre: "Short Running", precio: 69.90, precioOriginal: 89.90, descuento: 22, imagen: "/img/ropa-5.jpg", marca: "Nike" },
  { id: 6, nombre: "Chompas Hombre", precio: 149.90, precioOriginal: 179.90, descuento: 17, imagen: "/img/ropa-6.jpg", marca: "Adidas" },
]
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-7xl mx-auto p-4">
        <div className="flex items-center justify-between mb-6">
          <h1 className="text-2xl font-bold text-gray-800">Ropa</h1>
